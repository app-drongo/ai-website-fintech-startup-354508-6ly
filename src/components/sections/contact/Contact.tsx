...
const DEFAULT_CONTACT = {
  title: 'Contact Our Financial Experts',
  subtitle:
    'Ready to revolutionize your business finances? Connect with our fintech specialists to discover how our innovative solutions can accelerate your growth and streamline your financial operations.',
  aboutTitle: 'Why Choose Our Fintech Platform',
  aboutDescription:
    'We empower small and medium businesses with enterprise-grade financial technology. Our platform combines AI-driven insights, automated workflows, and bank-level security to help you make smarter financial decisions and scale faster.',
  aboutStats: [
    { icon: 'Users', value: '25,000+', label: 'Active Businesses' },
    { icon: 'TrendingUp', value: '40%', label: 'Average Cost Savings' },
    { icon: 'Shield', value: 'SOC 2', label: 'Compliance Certified' },
  ],
  formTitle: 'Start Your Financial Transformation',
  formDescription:
    'Schedule a personalized demo or get answers to your questions. Our fintech experts typically respond within 2 hours during business days.',
  nameLabel: 'Full Name',
  ...
  subjectPlaceholder: 'Select your primary interest',
  messageLabel: 'Tell us about your business',
  messagePlaceholder:
    'Describe your current financial challenges, business size, and what you hope to achieve with our platform...',
  submitText: 'Request Demo & Consultation',
  successMessage:
    'Thank you! Our fintech specialists will contact you within 2 business hours to schedule your personalized demo.',
  contactInfo: [
    {
      icon: 'Mail',
      title: 'Email Our Experts',
      value: 'solutions@fintechpro.com',
      description: 'Expert responses within 2 hours',
    },
    {
      icon: 'Phone',
      title: 'Speak with Specialists',
      value: '+1 (888) 346-8324',
      description: 'Mon-Fri 8AM-8PM EST',
    },
    {
      icon: 'MapPin',
      title: 'Financial District Office',
      value: '200 West Street, New York, NY 10282',
